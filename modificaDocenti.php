      ...
      <div id="containerCard" class="container-fluid">
        <div id="rigaContainer" class="row m-auto">
                <div id="colonna1" class="col-4 m-auto">
                    <div class="card h-100 bg-custom2" style="width: 20rem;">
                        <div class="card-body">
                            ...
                            <form action="modificaDocenti.php" method="POST">
                                ...
                                <div id="rigaIndirizzo" class="row m-auto mb-2">
                                    <div id="colonnaVia" class="col-5 m-auto">
                ...
                <div id="colonna2" class="col-4 m-auto">
                    <div class="card h-100 bg-custom2" style="width: 20rem;">
                        <div class="card-body">
                            <h5 class="card-title">Rimuovi Docente</h5>
                            <form action="modificaDocenti.php" method="POST">
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
        ...
        $query = 'INSERT INTO Universita.Docente (nome, cognome, data_di_nascita, telefono, email, via, cap, civico, password) VALUES ($1, $2, $6, $7, $8, $3, $5, $4, $9);';
        ...
        $result = pg_prepare($conn, "inserimento_docente", $query);
        

        $result = pg_execute($conn, "inserimento_docente", $parametri);
        if ($result) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['elimina'])) {
        ...
        // Query di inserimento
        $query = 'DELETE FROM universita.docente d WHERE d.id = $1';
        
        $parametri = Array(
            $id
        );

        $result = pg_prepare($conn, "eliminazione_docente", $query);
        $result = pg_execute($conn, "eliminazione_docente", $parametri);
